 ...
 * generated in the info.psidev.psi.pi.mzidentml._1_1 package. 
...
public class ObjectFactory {
    ...
    private final static QName _MzIdentML_QNAME = new QName("http://psidev.info/psi/pi/mzIdentML/1.1.1", "MzIdentML");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: info.psidev.psi.pi.mzidentml._1_1
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://psidev.info/psi/pi/mzIdentML/1.1.1", name = "MzIdentML")
